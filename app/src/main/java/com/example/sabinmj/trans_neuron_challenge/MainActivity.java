...
public class MainActivity extends AppCompatActivity implements OnClickListener{
   // Button writeExcelButton,readExcelButton;
    ...
    ListView Lvoutput;
    public ArrayList<String> Exceldata = new ArrayList<String>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);

        View writeExcelButton = findViewById(R.id.btnWriteExcel);
        writeExcelButton.setOnClickListener(this);
        View readExcelButton = findViewById(R.id.btnreadExcel);
        readExcelButton.setOnClickListener(this);
        Lvoutput= (ListView) findViewById(R.id.lvshowitem);
    }

    public void onClick(View v) {
        switch (v.getId()) {

            case R.id.btnWriteExcel:
                saveExcelFile(this,"myExcel.xls");
                break;
            case R.id.btnreadExcel:
        ...
        try{
            ...
            while(rowIter.hasNext()){
                ...
                while(cellIter.hasNext()){
                    ...
                    this.Exceldata.add(myCell.toString());
    ...
    protected void onStart() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getBaseContext(),
                android.R.layout.simple_list_item_1, Exceldata);
        Lvoutput.setAdapter(adapter);

//to retrieve the data for item select------>
        Lvoutput.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
